                    ...
                    <div class="md:col-span-2 mt-5 md:mt-0">
                        <div class="shadow bg-white md:rounded-md p-4">
                           <form @submit.prevent="submit">
                            ...
                            <a href="#" @click.prevent="destroy" class="bg-red-500 text-white font-bold py-2 px-4 rounded-md ">
                                Eliminar nota
                            </a>
                            <Link :href="route('notes.index', note.id)" class="bg-blue-500 text-white font-bold py-2 px-4 rounded-md ml-2">
                                 Volver
                            </Link>
                        </div>
                    </div>
